/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=WorkerBindings src/worker-bindings.d.ts` (hash: 0ea80c3862476b395df907d0ff072c8a)
// Runtime types generated with workerd@1.20260917.1 2026-09-18 nodejs_compat
interface __BaseEnv_WorkerBindings {
	CMS_JOBS: KVNamespace;
	VIDEO_REFERENCES: R2Bucket;
	VIDEO_UPLOAD_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TUZI_API_KEY" | "AUTODL_TOKEN" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
