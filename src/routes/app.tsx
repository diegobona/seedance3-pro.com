          ...
          <div className="workspace-body">
            ...
            <div className="creation-grid" id="creation-grid" hidden={initiallyPose}>
              <section className="creation-panel">
                ...
                <div className="field-group" id="mode-group" hidden={!initiallyH3}><label>Create from</label><div className="segmented"><button className="is-selected" type="button" data-video-mode="text" aria-pressed="true">Text to video</button><button type="button" data-video-mode="reference" aria-pressed="false">Reference to video</button></div></div>
                <div className="field-group" id="video-reference-group" hidden>
                  <div className="label-line"><label htmlFor="video-reference-input">Reference images</label><span id="video-reference-count">0 / 9</span></div>
                  <input id="video-reference-input" type="file" accept="image/png,image/jpeg,image/webp" multiple hidden />
                  <button className="upload-box is-enabled" id="video-reference-add" type="button"><span>＋</span><strong>Add reference images</strong><small>1–9 images · PNG, JPEG or WebP · max 10 MB each</small></button>
                  <div className="video-reference-grid" id="video-reference-grid" />
                  <p className="video-reference-hint">Describe how the subjects in Image 1, Image 2, etc. should interact. Images are numbered in upload order.</p>
                </div>
